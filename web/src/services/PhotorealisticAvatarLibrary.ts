...
export const PHOTOREALISTIC_AVATARS: PhotorealisticAvatar[] = [
  ...
  },
  {
    ...
    ethnicity: 'igbo',
    profession: 'Athlete',
    imageUrl: 'https://images.pexels.com/photos/5214946/pexels-photo-5214946.jpeg?auto=compress&cs=tinysrgb&w=800',
    thumbnailUrl: 'https://images.pexels.com/photos/5214946/pexels-photo-5214946.jpeg?auto=compress&cs=tinysrgb&w=200',
    lipSyncPoints: STANDARD_LIP_SYNC,
    faceRect: STANDARD_FACE_RECT,
